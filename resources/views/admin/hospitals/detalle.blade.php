                                ...
                                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="table-row bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                            <td class="px-6 py-4" data-date="{{ $pedido->created_at }}">{{ $pedido->created_at }}</td>
                                            <td class="px-6 py-4" data-amount="{{ $pedido->monto }}">${{ $pedido->monto }}</td>
                                            <td class="px-6 py-4" data-delivery="{{ $pedido->fecha_pedido }}">{{ $pedido->fecha_pedido }}</td>
                                            <td class="px-6 py-4" data-status="{{ $pedido->estatus }}">{{ $pedido->estatus }}</td>
                                        </tr>
                                    @endforeach
