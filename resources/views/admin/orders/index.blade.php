<x-app-layout>
                        ...
                        @foreach ($pedidos as $pedido)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <a type="button" class="text-orange-700 detalles-btn"
                                        data-id="{{ $pedido->id }}">
                                        Detalles
                                    </a>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            detallesButtons.forEach(button => {
                button.addEventListener('click', function(event) {
                    event
                .preventDefault(); // Evita el comportamiento predeterminado del enlace/button
        ...
        //cerrar modal
        var closeButton = document.querySelector('[data-modal-hide="defaultModal"]');

        // Agrega un evento de clic al botón de cerrar
        if (closeButton) {
            closeButton.addEventListener('click', function() {
                // Encuentra el modal por su ID y ocúltalo
