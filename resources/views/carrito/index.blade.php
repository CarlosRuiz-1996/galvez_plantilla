    ...
    <div class="py-12">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div class="text-center">
                            ...
                            <h3 class="mt-4 text-xl font-semibold text-gray-900 dark:text-white" id="productName">
                            </h3>
                            ...
                            <p class="text-base font-semibold text-gray-900 dark:text-white" id="productPresentation">
                            </p>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                ...
                function openModal(productPrice, productDescription, productImage, productBrand, productGrammage,
                    productPresentation) {
                ...
                openModalButtons.forEach(button => {
                    button.addEventListener("click", function() {
                        ...
                        openModal(productPrice, productDescription, productImage, productBrand,
                            productPresentation, productGrammage);
                    });
                });
